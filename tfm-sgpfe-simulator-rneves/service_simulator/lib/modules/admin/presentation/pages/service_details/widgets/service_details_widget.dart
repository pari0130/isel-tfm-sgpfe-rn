...
class ServiceDetailsWidget extends StatefulWidget {
  @override
  State<ServiceDetailsWidget> createState() => _ServiceDetailsState();
}

class _ServiceDetailsState extends State<ServiceDetailsWidget> {
    ...
    return Column(
      children: [
                  ...
                  Row(
                    children: [
                      OutlineButton(
                        ...
                        onPressed: () {
                          overlay.show();
                          BlocProvider.of<AdminServiceDetailsBloc>(context).add(
        ...
        Flexible(
          child: BlocProvider(
            create: (context) {
              return BlocProvider.of<AdminServiceDetailsBloc>(context)
                ..add(
                    ServicePostOfficeFetch(serviceId: arguments["service_id"]));
            },
            child:
                BlocConsumer<AdminServiceDetailsBloc, AdminServiceDetailsState>(
              listener: (context, state) {
                ...
                if (state is ServiceDetailsUpdated) {
                  ...
                  ServiceDetailsPage.of(context).changed = SERVICE_CHANGED;
  ...
  Widget _popupDelete(context, id) {
    ...
    Widget yesButton = FlatButton(
      ...
      onPressed: () {
        BlocProvider.of<AdminServiceDetailsBloc>(context)
