...
class ServiceAdminServiceDetailsBloc
    extends Bloc<ServiceAdminServiceDetailsEvent, ServiceAdminServiceDetailsState> {
  final AuthenticationBloc authenticationBloc;
  final ServiceRepository serviceRepository;

  ServiceAdminServiceDetailsBloc(
      {@required this.authenticationBloc, @required this.serviceRepository})
      : super(ServiceUninitialized());

  @override
  Stream<ServiceAdminServiceDetailsState> mapEventToState(
    ServiceAdminServiceDetailsEvent event,
  ) async* {
